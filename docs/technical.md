...
**Sprint 8 / DOC-3** — архитектура, криптографические решения, схема БД и форматы данных.
...
2. [Криптографические решения](#2-криптографические-решения)
3. [Структуры данных и схема БД](#3-структуры-данных-и-схема-бд)
4. [Тестирование и качество](#4-тестирование-и-качество)
5. [Сборка и развёртывание](#5-сборка-и-развёртывание)
...
## Соответствие требованиям DOC-3

| Требование | Раздел |
|------------|--------|
| Обзор архитектуры | §1 (Mermaid, bootstrap, EventBus) |
| Криптография (AES-GCM, Argon2, …) | §2 |
| Структуры данных и схема БД | §3 |

---

## См. также

- [user_guide.md](user_guide.md) — руководство пользователя (DOC-2)
- [README.md](../README.md) — обзор, установка, скриншоты (DOC-1)
- [sprints/sprint8.md](../sprints/sprint8.md) — ТЗ Sprint 8
